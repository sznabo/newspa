...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover"><a>>>添加消息</a></li>
                 </ul>
           </div>
     ...
     <div class="AlonModule_Body">
			<s:form action="savemessageAction" namespace="/message" method="post">
				<table width="98%" class="listtable">
					<tr  class="TableTitle">
						<th scope="row" align="right">标题：</th>
						<td class="inp">
							<input name="message.title" id="title" maxlength="30" size="30"/><font style="color: red; margin-left: 10">*</font>
						</td>
					</tr>
					<tr>
						<th scope="row" align="right">状态：</th>
						<td >
							<s:radio list="#{0:'停用', 1:'启用'}" name="message.status" value="1" id="sta"></s:radio>
					...
					<tr id="MessagePlayType" style="display: none;">
						...
						<td class="inp">
							<input type="text" name="message.startDate" id="startDate" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'endDate\',{d:-1})}',dateFmt:'yyyy-MM-dd'})" 
									style="width:150px; height:20px; font-size:12px; border:solid 1px #ccc; margin-right:10" />
							至
							<input type="text" name="message.endDate" id="endDate"  onclick="WdatePicker({minDate:'#F{$dp.$D(\'startDate\',{d:0})}',dateFmt:'yyyy-MM-dd'})" 
					...
					<tr style="display: none;">
						...
						<td >
							<s:radio list="#{1:'顶部', 2:'底部'}" name="message.position" value="1" id="position"></s:radio>
						</td>
					</tr>
					
					<tr>
						<th scope="row" align="right" valign="top">内容：</th>
						<td class="inp">
							<s:textarea name="message.content" id="content" cols="38" wrap="20" rows="5"></s:textarea>
							<font style="color: red; margin-left: 10">*</font>
						</td>
					</tr>
...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover"><a>>>Add Message</a></li>
                 </ul>
           </div>
           <div class="AlonModule_Top3"><img alt="" src="res/images/TopColumn3.png"/></div>
     </div>
     ...
     <div class="AlonModule_Body">
			<s:form action="message/savemessageAction.action" method="post">
				<table width="98%" class="listtable">
					<tr  class="TableTitle">
					...
					<tr>
						...
						<td >
							<s:radio list="#{0:'disable', 1:'To enable the'}" name="message.status" value="1" id="sta"></s:radio>
							<font style="color: red; margin-left: 10">*</font>
						</td>
					</tr>
					...
					<tr>
						...
						<td valign="top" class="inp">
							<s:radio list="#{1:'Real-time playback', 2:'Timing play'}" id="playType" value="1" name="playType" cssClass="playType" onclick="showPlayType()"></s:radio>
							<font style="color: red; margin-left: 10">*</font>
						</td>
					</tr>
					...
					<tr style="display: none;">
						...
						<td >
							<s:radio list="#{1:'At the top of the', 2:'At the bottom of the'}" name="message.position" value="1" id="position"></s:radio>
						</td>
					</tr>
					
					<tr>
						<th scope="row" align="right" valign="top">Content:</th>
						<td class="inp">
							<s:textarea name="message.contente" id="content" cols="38" wrap="20" rows="5"></s:textarea>
							<font style="color: red; margin-left: 10">*</font>
						</td>
					</tr>
				  ...
				  <tr>
				  	<td>&nbsp;</td>
						 <td class="addButton">
					        ...
					        <input type="button" value="return" class="back"  onclick="back();"/>
					    </td>
					</tr>
				</table>
			</s:form>
