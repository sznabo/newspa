...
if(a==2){
	...
	if($("#pic").val().trim() == ""){
		alert("Please select a album LOGO");
		return false;
	}
	return true;
}
...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover"><a>>>添加分组</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="save" namespace="/songCategory" enctype="multipart/form-data" method="post" onsubmit="return checkForm()">
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
			<tr>
				<th scope="row" align="right">分组名称：</th>
				<td class="inp">
					<input name="songCategory.name" id="name" maxlength="30" /><font style="color: red; margin-left: 10">*</font>
				</td>
			</tr>
			
			<tr>
				<th scope="row"  align="right">专辑图片：</th>
				<td class="inp">
					<input name="pic" id="pic"  type="file" /><font style="color: red; margin-left: 10">*</font>
					注：图片分辨率488px * 360px
				</td>
			</tr>
     ...
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
			<tr>
				...
				<td class="inp">
					<input name="songCategory.namee" id="name" maxlength="30" /><font style="color: red; margin-left: 10">*</font>
				</td>
			</tr>
			
			<tr>
				<th scope="row"  align="right">The album image:</th>
				<td class="inp">
					<input name="pic" id="pic"  type="file" /><font style="color: red; margin-left: 10">*</font>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Note: the image resolution488px * 360px
				</td>
			</tr>
