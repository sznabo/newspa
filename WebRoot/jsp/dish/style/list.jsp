...
var a = <%=session.getAttribute("language")%>
	function del(id) {if(a==1){
		if (window.confirm("确定要删除吗?")) {
			window.location.href = "dishStyle/delete.action?idList="+id;
		}
	}
	if(a==2){
	...
	//编辑
	function edit(id){
		location.href = "dishStyle/toupdate.action?model.id="+id;
	}	
...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul> 
                 	    ...
                 	    <li class="currentHover"><a style="white-space: nowrap;" href="<%=basePath%>dishStyle/list.action">菜品分类</a></li>
                 </ul>
           </div>
     ...
     <div class="AlonModule_Body">
          <div class="AlonModule_list">
	           ...
	           <s:form method="post" action="list" namespace="/dishStyle">
	           <div class="ProgramList_Search">
	                         ...
	                         <div class="add_dar" style="margin-right:10px">
	                              ...
	                              <div class="add_darBackground"> 
	                              	 <a href="<%=basePath%>dishStyle/toadd.action"><img alt="" src="res/images/Gnome-List-Add-32.png"/> 添加</a>
	           ...
	           <div class="ContentInformation">
	                <table width="100%" class="table1">
					  <tr class="TableTitle">
					    ...
					    <th scope="col" width="25%" height="30" class="STYLE1" nowrap="nowrap" bgcolor="#EEEEEE">图片</th>
					    <th scope="col" width="15%" height="30" class="STYLE1" nowrap="nowrap" bgcolor="#EEEEEE">操作</th>
					  </tr>
					  
					 <s:form namespace="/dishStyle" action="delete" method="post" id="delForm">
					  ...
					  <tr>
					    ...
					    <!-- 图片-->
					    <td nowrap="nowrap"><img src="${item.img}" width="200" height="100"/>  </td>
					    <!-- 编辑 -->				    
					...
					<tr>
						<td colspan="4">
							...
							<jsp:include page="/jsp/page.jsp" flush="false">
								<jsp:param value="dishStyle/list.action" name="actionName"/>
							</jsp:include>
							</div>
						</td>
					</tr>
     ...
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul> 
                 	    ...
                 	    <li class="currentHover"><a style="white-space: nowrap;" href="<%=basePath%>dishStyle/list.action">Dish Type</a></li>
                 </ul>
           </div>
           <div class="AlonModule_Top3"><img alt="" src="<%=basePath%>res/images/TopColumn3.png"/></div>
     </div>
          ...
          <div class="AlonModule_list">
	           ...
	           <div class="ProgramList_Search">
	                         ...
	                         <div class="add_dar" style="margin-right:10px">
	                              <div class="add_darImg1"><img src="res/images/icons_01.png"/></div>
	                              <div class="add_darBackground"> 
	                              	 <a href="<%=basePath%>dishStyle/toadd.action"><img alt="" src="res/images/Gnome-List-Add-32.png"/>add</a>
	           ...
	           <div class="ContentInformation">
	                <table width="100%" class="table1">
					  <tr class="TableTitle">
					    ...
					    <th scope="col" width="25%" height="30" class="STYLE1" nowrap="nowrap" bgcolor="#EEEEEE">picture</th>
