...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      <li  ><a href="<%=basePath%>product/list.action">产品管理</a></li>
                      <li class="currentHover"><a>>>添加产品</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="save" namespace="/product" method="post" onsubmit="return checkForm()">
     <div class="AlonModule_Body">
		<table width="98%" class="listtable" >
			<tr>
				<th scope="row" align="right">产品名称：</th>
				<td class="inp">
					<input name="product.name" id="name" maxlength="30" /><font style="color: red; margin-left: 10">*</font>
				</td>
		  	<tr>
		  	<tr>
...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      <li  ><a href="<%=basePath%>product/list.action">Product management</a></li>
                      <li class="currentHover"><a>>>Add product</a></li>
                 </ul>
           </div>
           <div class="AlonModule_Top3"><img alt="" src="res/images/TopColumn3.png"/></div>
     </div>
