...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover"><a>修改管理员</a></li>
                 </ul>
           </div>
	...
	<s:form action="update" namespace="/admin" method="post" onsubmit="return checkForm();">
     ...
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
			<tr>
				...
				<td class="inp">
					<div style="padding-left:5px;">${admin.loginName}</div>
				</td>
			</tr>
			<tr>
				<th scope="row" align="right">姓名：</th>
				<td class="inp">
					<s:textfield name="admin.userName" maxlength="30" id="userName"></s:textfield>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="inp">
					<input type="password" maxlength="30" id="password" value="${admin.password}"/>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
