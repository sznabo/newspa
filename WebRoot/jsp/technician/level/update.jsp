...
function back(){
	location.href = "technicianLevel/list.action";
}
...
<div class="AlonModule">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                     ...
                     <li class="currentHover"><a style="white-space: nowrap;" href="<%=basePath%>technicianLevel/list.action">级别管理</a></li>
                      <li class="currentHover"><a>>>修改级别名称</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="update" namespace="/technicianLevel" method="post" onsubmit="return checkForm()">
		...
		<table width="98%" class="listtable">
			<tr>
				...
				<td class="inp" align="left">
					<s:textfield name="model.name" id="name" maxlength="30"/><font style="color: red; margin-left: 10">*</font>
				</td>
			</tr>
		  	<tr>
		  	<td>&nbsp;</td>
           ...
           <div class="AlonModule_Top2">
                 <ul>
                     ...
                     <li class="currentHover"><a style="white-space: nowrap;" href="<%=basePath%>technicianLevel/list.action">Level management</a></li>
                      <li class="currentHover"><a>>>Modify the level name</a></li>
                 </ul>
           </div>
           <div class="AlonModule_Top3"><img alt="" src="res/images/TopColumn3.png"/></div>
     </div>
     ...
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
			<tr>
				...
				<td class="inp" align="left">
					<s:textfield name="model.namee" id="name" maxlength="30"/><font style="color: red; margin-left: 10">*</font>
				</td>
			</tr>
		  	<tr>
		  	<td>&nbsp;</td>
