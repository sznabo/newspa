...
var a = <%=session.getAttribute("language")%>
	function del(id) {if(a==1){
		if (window.confirm("确定要删除吗?")) {
			window.location.href = "technicianType/delete.action?idList="+id;
		}
	}
	if(a==2){
	...
	//编辑
	function edit(id){
		location.href = "technicianType/toupdate.action?model.id="+id;
	}	
...
<div class="AlonModule">
     ...
     <div class="AlonModule_Body">
          <div class="AlonModule_list">
	           ...
	           <s:form method="post" action="list" namespace="/technicianType">
	           <div class="ProgramList_Search">
	                         ...
	                         <div class="add_dar" style="margin-right:10px">
	                              ...
	                              <div class="add_darBackground"> 
	                              	 <a href="<%=basePath%>technicianType/toadd.action"><img alt="" src="res/images/Gnome-List-Add-32.png"/> 添加</a>
	           ...
	           <div class="ContentInformation">
	                <table width="100%" class="table1">
					 ...
					 <s:form namespace="/technicianType" action="delete" method="post" id="delForm">
					...
					<tr>
						<td colspan="4">
							...
							<jsp:include page="/jsp/page.jsp" flush="false">
								<jsp:param value="technicianType/list.action" name="actionName"/>
							</jsp:include>
							</div>
						</td>
					</tr>
          ...
          <div class="AlonModule_list">
	           ...
	           <div class="ProgramList_Search">
	                         ...
	                         <div class="add_dar" style="margin-right:10px">
	                              <div class="add_darImg1"><img src="res/images/icons_01.png"/></div>
	                              <div class="add_darBackground"> 
	                              	 <a href="<%=basePath%>technicianType/toadd.action"><img alt="" src="res/images/Gnome-List-Add-32.png"/> add</a>
	           ...
	           <div class="ContentInformation">
	                <table width="100%" class="table1">
					  <tr class="TableTitle">
					    ...
					    <th scope="col" width="25%" height="30" class="STYLE1" nowrap="nowrap" bgcolor="#EEEEEE">Image:</th>
