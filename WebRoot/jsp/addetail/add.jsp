...
<div class="AlonModule">
                 ...
                 <ul>
                    ...
                    <s:if test="#session.showFlag == 2">
                 	...
                 	<s:if test="#session.showFlag == 3">
                      ...
                      <li class="currentHover">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="white-space: nowrap;" href="<%=basePath%>addetail/list.action">增加【${sessionScope.curAd.name}】内容</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="save" namespace="/addetail" method="post" enctype="multipart/form-data"  onsubmit="return checkForm()">
     <div class="AlonModule_Body">
                 ...
                 <ul>
                    ...
                    <s:if test="#session.showFlag == 2">
                 		<li ><a style="white-space: nowrap;" href="<%=basePath%>admin/vodPartAction_listVodPart.action?type=goListVodPart">Film management</a></li>
                      	<li ><a style="white-space: nowrap;" href="<%=basePath%>ad/list.action?showFlag=2">On demand advertising</a></li>
                 	</s:if>
                 	<s:if test="#session.showFlag == 3">
                      ...
                      <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="white-space: nowrap;" href="<%=basePath%>addetail/list.action">【${sessionScope.curAd.name}】Detail list</a></li>
                      <li class="currentHover">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="white-space: nowrap;" href="<%=basePath%>addetail/list.action">增加【${sessionScope.curAd.name}】内容</a></li>
                 </ul>
           </div>
           <div class="AlonModule_Top3"><img alt="" src="res/images/TopColumn3.png"/></div>
		...
		<table width="98%" class="listtable">
			...
			<tr>	
				...
				<td class="inp">
					...
					<s:if test="adid == 1">
					<!-- 首页-本店介绍封面 -->
				        	Note:Image resolution330px * 527px 
				     </s:if>
				     <s:elseif test="adid == 2">
				     <!-- 首页-电影点播 -->
				     ...
				     <!-- 音乐欣赏 -->
				                 <!-- 204px * 195px  -->
				            Note: the image resolution296px * 259px
				     </s:elseif>
				     <s:elseif test="adid == 11">
				     <!-- 电视直播 -->
				                <!-- 892px * 609px --> 
