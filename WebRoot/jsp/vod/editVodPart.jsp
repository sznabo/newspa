...
if(a==1){
  ...
  if(a==2){
	...
	var param = "model.vodpartname="+name+"&model.id="+${model.id};
	var exist = false;
	$.ajax({
		type:  "POST",
		async: false,
...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover"><a>>>修改影片类别信息</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="vodPartAction_updateVodPart" namespace="/admin" method="post" enctype="multipart/form-data">
     <div class="AlonModule_Body">
		...
		<s:hidden name="model.id" ></s:hidden>
			<tr>
				...
				<td class="inp">
					<s:textfield maxlength="30" size="60" name="model.vodpartname" id="vodpartname"/><font style="color:red;">*</font>
				</td>
			</tr>
			<tr>
			...
			<%-- <tr>
				...
				<td class="inp">
					<s:textarea name="model.partintr" id="partintr"  cols="80" rows="5" ></s:textarea>
...
<div class="AlonModule">
	 ...
	 <div class="AlonModule_Body">
	 <div class="AlonModule_list">
	 <s:form action="vodPartAction_updateVodPart.action" namespace="/admin" method="post" enctype="multipart/form-data">
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
		<s:hidden name="model.id" ></s:hidden>
			<tr>
				...
				<td class="inp">
					<s:textfield maxlength="30" size="60" name="model.vodpartnamee" id="vodpartname"/><font style="color:red;">*</font>
				</td>
			</tr>
			<tr>
