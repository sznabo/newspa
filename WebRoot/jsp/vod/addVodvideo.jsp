...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="white-space: nowrap;" href="<%=basePath%>admin/vodVideoAction_skip.action">>>添加节目续集</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="vodVideoAction_saveVodvideo" namespace="/admin" method="post">
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
			...
			<tr>
				...
				<td class="inp">
					<s:textfield name="voidname" id="voidname" maxlength="50"></s:textfield>
...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      <li><a style="white-space: nowrap;" href="<%=basePath%>admin/vodPartAction_listVodPart.action?type=goListVodPart">On demand program management</a></li>
                      <li><a style="white-space: nowrap;" href="<%=basePath%>admin/vodProgram_viewVodprogram.action?type=goListVodPart">【${sessionScope.vodpart.vodpartname}】Shows a list of</a></li>
                      <li>&nbsp;&nbsp;&nbsp;&nbsp;<a style="white-space: nowrap;" onclick="window.history.go(-1);">【${vodprogram.voidprogramname}】Show show series</a></li>
                      <li class="currentHover">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="white-space: nowrap;" href="<%=basePath%>admin/vodVideoAction_skip.action">>>Add show a sequel</a></li>
                 </ul>
           </div>
           <div class="AlonModule_Top3"><img alt="" src="res/images/TopColumn3.png"/></div>
     </div>
	 <div class="AlonModule_Body">
	 <div class="AlonModule_list">
	 <s:form action="vodVideoAction_saveVodvideo.action" namespace="/admin" method="post">
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
				<s:hidden name="id" id="id" value="%{model.id}"></s:hidden>
				<s:hidden name="vodprogramid" id="vodprogramid" value="%{model.vodprogramid}"></s:hidden>
			<tr>
				<th scope="row" align="right">name of the video：</th>
				<td class="inp">
					<s:textfield name="voidnamee" id="voidname" maxlength="50"></s:textfield>
					<font style="color:red;">*</font>
				</td>
			</tr>
			<tr>
