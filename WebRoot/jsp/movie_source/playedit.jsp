...
<div class="AlonModule" >
     <div class="AlonModule_Top" >
           ...
           <div class="AlonModule_Top2" >
                 <ul>
                      ...
                      <li class="currentHover"><a>>>修改电影源</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="update" namespace="/movieSource" method="post" enctype="multipart/form-data">
     <div class="AlonModule_Body">
		...
		<s:hidden name="model.id"></s:hidden>
			<tr>
				...
				<td class="inp">
					<s:textfield maxlength="30" size="60" name="model.source_name" id="name"></s:textfield>
		    ...
		    <tr>
				...
				<td >
					<s:radio list="#{0:'禁用', 1:'启用'}" name="model.source_state" id="sta"></s:radio>
					<font style="color: red">*</font>
				</td>
			</tr>
