...
<script type="text/javascript">
	...
	//编辑
	function edit(id){
		location.href = "movieSource/toUpdate.action?model.id=" + id ;
	}	
           ...
           <div class="AlonModule_Top2">
                 <ul> 
                 	<li ><a style="white-space: nowrap;" href="<%=basePath%>admin/vodPartAction_listVodPart.action?type=goListVodPart">影片管理</a></li>
                      	...
                      	<li class="currentHover"><a href="<%=basePath%>movieSource/list.action">切换电影源</a></li>
                 </ul>
           </div>
          ...
          <div class="AlonModule_list">
	           ...
	           <div class="ContentInformation">
	                <table width="100%" class="table1">
					 ...
					 <s:form namespace="/movieSource" action="list" method="post" id="delForm" cssClass="delForm">
					  <s:iterator value="movie" id="item" status="st">
					  <tr id="otd">
				        ...
				        <s:if test="#item.id == 1">
				        <s:property value="source_name"/></a>
				        </s:if> 
				        <s:if test="#item.id == 2">
				        <s:property value="source_name"/></a>
				        </s:if>
				        ...
				        <td width="37%" height="25" class="STYLE1" nowrap="nowrap" align="center" bgcolor="#EEEEEE"><div align="center" class="texthidden_150">
				            <s:if test="#item.source_state == 0">禁用</s:if>
					    	<s:if test="#item.source_state == 1">启用</s:if>
				        </div></td>
						<!-- 操作 -->				
