     ...
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover"><a>>>添加留言信息</a></li>
                 </ul>
           </div>
			...
			<s:form action="serverMsgAction_saveServerMsg" namespace="/servermsg" method="post">
				<table width="98%" class="listtable">
					<tr  class="TableTitle">
						...
						<td class="inp">
							<input name="model.title" id="title" maxlength="30" /><font style="color: red; margin-left: 10">*</font>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="inp">
							<s:textarea name="model.content" rows="8" id="content" cols="50" wrap="20"></s:textarea>
			...
			<s:form action="servermsg/serverMsgAction_saveServerMsg.action" method="post">
				<table width="98%" class="listtable">
					...
					<tr>
						...
						<td class="inp">
							<s:textarea name="model.contente" rows="8" id="content" cols="50" wrap="20"></s:textarea>
							<font style="color: red; margin-left: 10">*</font>
						</td>
					</tr>
