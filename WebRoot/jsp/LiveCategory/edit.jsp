...
<div class="AlonModule" >
     <div class="AlonModule_Top" >
           ...
           <div class="AlonModule_Top2" >
                 <ul>
                      ...
                      <li class="currentHover"><a>>>修改直播分类信息</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="update" namespace="/liveCategory" method="post" enctype="multipart/form-data">
     <div class="AlonModule_Body">
		...
		<s:hidden name="model.id"></s:hidden>
			...
			<tr>
				...
				<td class="inp">
					<b:fileUpload uploadSavePath="upload/live_category/" name="model.path" id="path"/>(不选择表示不更换)
					<span>
		    ...
		    <tr>
				...
				<td >
					<s:radio list="#{0:'禁用', 1:'启用'}" name="model.statusConfig" id="sta"></s:radio>
					<font style="color: red">*</font>
				</td>
			</tr>
