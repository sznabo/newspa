...
<div class="AlonModule">
	 ...
	 <s:form action="update" namespace="/mainAd" method="post" enctype="multipart/form-data">
     <div class="AlonModule_Body">
		...
		<s:hidden name="model.id" ></s:hidden>
			<tr>
				...
				<td class="inp">
				  ...
				  <s:textfield maxlength="30" size="60" type="text" name="model.name" id="name"></s:textfield>
			...
			<tr>
				...
				<td class="inp">
					<s:select name="model.type" style="height:22px;" id="type" onchange='btnChange(this[selectedIndex].value);'
							list="%{#{1:'图片',2:'视频'}}">
						</s:select>
					<font style="color:red;">*</font>
				</td>
			...
			<tr>
				...
				<font style="color:red;">*未选择代表不更改  </font>${model.filePath}   
				</td>
			</tr> 
			
			<tr id="musicTr" <s:if test="%{model.type==2}">style="display:none;" </s:if>>
				<th scope="row" align="right">音频文件：</th>
				<td class="inp">
					<b:fileUpload uploadSavePath="upload/mainAd/" name="model.musicPath" id="musicPath"/>
				<font style="color:red;">*未选择代表不更改</font>${model.musicPath}
				</td>
			</tr> 
     ...
     <div class="AlonModule_Body">
		...
		<s:hidden name="model.id" ></s:hidden>
			...
			<tr>
				...
				<td class="inp">
					<b:fileUpload uploadSavePath="upload/mainAd/" name="model.filePath" id="filePath"/>
				<br/><font style="color:red;">*Not selected representative does not change  </font>${model.filePath}   
				</td>
			</tr> 
			...
			<tr id="musicTr" <s:if test="%{model.type==2}">style="display:none;" </s:if>>
				...
				<td class="inp">
					<b:fileUpload uploadSavePath="upload/mainAd/" name="model.musicPath" id="musicPath"/>
				<font style="color:red;">*Not selected representative does not change</font>${model.musicPath}
				</td>
			</tr> 
