...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover"><a>>>修改设备分类</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="update" namespace="/deviceCategory" method="post" onsubmit="return checkForm();">
	 <s:hidden name="deviceCategory.id"></s:hidden>
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
			<tr>
				<th scope="row">分类名称：</th>
				<td class="inp">
					<s:textfield name="deviceCategory.name" maxlength="20" id="name"/><font style="color: red; margin-left: 10">*</font>
				</td>
			</tr>
		  	<tr>
		  	<td>&nbsp;</td>
