...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover"><a>>>修改模拟直播信息</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="liveManagementAction_updateLiveManagement" namespace="/live" method="post">
     <div class="AlonModule_Body">
		...
		<s:hidden name="model.id" ></s:hidden>
			<tr>
				...
				<td class="inp">
					<s:textfield maxlength="30" size="60" name="model.name" id="name"/><font style="color:red;">*</font>
				</td>
			</tr>
			<tr>
				<th scope="row" align="right">频率：</th>
				<td class="inp">
					<s:textfield maxlength="30" name="model.freq" id="freq"/>
...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul>
                      ...
                      <li class="currentHover"><a>>>Modify the analog broadcast information</a></li>
                 </ul>
           </div>
           <div class="AlonModule_Top3"><img alt="" src="res/images/TopColumn3.png"/></div>
     </div>
	 <div class="AlonModule_Body">
	 <div class="AlonModule_list">
	 <s:form action="liveManagementAction_updateLiveManagement.action" namespace="/live" method="post">
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
		<s:hidden name="model.id" ></s:hidden>
			<tr>
			...
			<tr>
		  	...
		  	<td>&nbsp;</td>
			 <td class="addButton">
		        <input type="submit" value="sumit" onclick="return checkEmpty()" class="STYLE1" />
