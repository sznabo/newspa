...
<script type="text/javascript">
	...
	function del(id) {if(a==1){
		...
		if (window.confirm("确定要删除吗?")) {
			window.location.href = "appCategory/delete.action?idList=" + id ;
		}
	}
	if(a==2){
		//var lv = document.getElementById("lv").value;
	...
	//编辑
	function edit(id){
		location.href = "appCategory/toUpdate.action?model.id=" + id ;
	}	
	           ...
	           <div class="ProgramList_Search">
	                         ...
	                         <div class="add_dar" style="margin-right:10px;">
	                              ...
	                              <div class="add_darBackground">
	                                <a href="<%=basePath%>appCategory/toAdd.action"><img alt="" src="res/images/Gnome-List-Add-32.png"/> 添加</a>
	                ...
	                <table width="100%" class="table1">
					 ...
					 <s:form namespace="/appCategory" action="delete" method="post" id="delForm" cssClass="delForm">
					  ...
					  <tr id="otd">
				        ...
				        <s:if test="#item.id == 3"><s:property value="name"/></s:if>
				        <s:elseif test="#item.id == 4"><a style="color: blue;" href="<%=basePath%>appCategoryDetail/list.action?categoryId=${id}"><s:property value="name"/></a></s:elseif>
				        <s:else><a style="color: blue;" href="<%=basePath%>appInfo/list.action?appInfo.category=${id}"><s:property value="name"/></a>
				       </s:else>
						...
						<!-- 操作 -->				
							...
							<td class="Operating" nowrap="nowrap" width="15%">
						    	...
						    	<s:elseif test="#item.id ==4"></s:elseif>
						    	<s:else><a href="javascript:void(del(${item.id}));"><img alt="" src="res/images/Delete.png"/>【删除】</a></s:else>
					...
					<tr>
						<td colspan="5">
							...
							<jsp:include page="/jsp/page.jsp" flush="false">
								<jsp:param value="appCategory/list.action" name="actionName"/>
							</jsp:include>
							</div>
						</td>
					</tr>
...
<div class="AlonModule">
     <div class="AlonModule_Top">
           ...
           <div class="AlonModule_Top2">
                 <ul> 
                 	<li class="currentHover"><a style="white-space: nowrap;" href="<%=basePath%>appCategory/list.action">App</a></li>
                 </ul>
           </div>
           <div class="AlonModule_Top3"><img alt="" src="<%=basePath%>res/images/TopColumn3.png"/></div>
     </div>
          ...
          <div class="AlonModule_list">
	           ...
	           <div class="ProgramList_Search">
	                         ...
	                         <div class="add_dar" style="margin-right:10px;">
	                              <div class="add_darImg1"><img src="res/images/icons_01.png"/></div>
	                              <div class="add_darBackground">
	                                <a href="<%=basePath%>appCategory/toAdd.action"><img alt="" src="res/images/Gnome-List-Add-32.png"/>Add</a>
	                ...
	                <table width="100%" class="table1">
					 ...
					 <s:form namespace="/appCategory" action="appCategory/delete.action" method="post" id="delForm" cssClass="delForm">
					  ...
					  <tr id="otd">
					    ...
					    <!-- 栏目名称-->
				        <td width="29%" height="25" class="STYLE1" nowrap="nowrap" align="center" bgcolor="#EEEEEE" ><div align="center">
				        <s:if test="#item.id == 3"><s:property value="namee"/></s:if>
				        <s:elseif test="#item.id == 4"><a style="color: blue;" href="<%=basePath%>appCategoryDetail/list.action?categoryId=${id}"><s:property value="namee"/></a></s:elseif>
				        <s:else><a style="color: blue;" href="<%=basePath%>appInfo/list.action?appInfo.category=${id}"><s:property value="namee"/></a>
				       </s:else>
						...
						<!-- 操作 -->				
							...
							<td class="Operating" nowrap="nowrap" width="15%">
						    	...
						    	<s:elseif test="#item.id ==4"></s:elseif>
						    	<s:else><a href="javascript:void(del(${item.id}));"><img alt="" src="res/images/Delete.png"/>【Delete】</a></s:else>
