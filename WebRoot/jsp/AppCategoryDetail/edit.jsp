...
<div class="AlonModule" >
           ...
           <div class="AlonModule_Top2" >
                 <ul>
                    ...
                    <li><a style="white-space: nowrap;" href="<%=basePath%>appCategoryDetail/list.action">【${sessionScope.usName}】明细列表</a></li>
                      <li class="currentHover"><a>>>修改${model.name}信息</a></li>
                 </ul>
           </div>
	 ...
	 <s:form action="update" namespace="/appCategoryDetail" method="post" enctype="multipart/form-data">
     <div class="AlonModule_Body">
		...
		<s:hidden name="model.id"></s:hidden>
			...
			<tr>
				...
				<td class="inp">
					<textarea rows="30" cols="50" name="model.content" id="content">${model.content }</textarea>
...
<div class="AlonModule" >
           ...
           <div class="AlonModule_Top2" >
                 <ul>
                    ...
                    <li><a style="white-space: nowrap;" href="<%=basePath%>appCategoryDetail/list.action">【${sessionScope.usName}】The detail list</a></li>
                      <li class="currentHover"><a>>> modify${model.name}information</a></li>
                 </ul>
           </div>
           <div class="AlonModule_Top3" ><img alt="" src="res/images/TopColumn3.png"/></div>
     </div>
	 <div class="AlonModule_Body" style="overflow:hidden;">
	 <div class="AlonModule_list" >
	 <s:form action="appCategoryDetail/update.action" namespace="/appCategoryDetail" method="post" enctype="multipart/form-data">
     <div class="AlonModule_Body">
		<table width="98%" class="listtable">
		<s:hidden name="model.id"></s:hidden>
			<tr>
			...
			<tr>
				...
				<td class="inp">
					<textarea rows="30" cols="50" name="model.contente" id="content">${model.contente }</textarea>
